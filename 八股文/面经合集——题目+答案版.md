...
>
>   <img src="assets/image-20250212140936082.png" alt="image-20250212140931011" style="zoom:50%;" /><img src="assets/image-20250212140944364.png" alt="image-20250212140944364" style="zoom:50%;" />
>
...
int main() {
	Genshin* g = nullptr;
	g->print(); //不会报错,因为函数在代码区，调用时的隐式逻辑实际上是Genshin::print(Genshin& g)，也就是隐式地包含this指针，对于静态成员函数来说则是没有这个this指针
...
std::unique_ptr<Genshin> unique(shared.get()); // 危险！
cout << shared.use_count() << endl; //1
```
